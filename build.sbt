...
lazy val cromwellClientInterface = project
  .withExecutableSettings("cromwell-client-interface", cromwellClientInterfacelDependencies)
  .dependsOn(core)
  .dependsOn(cwl)
  .dependsOn(cromwellApiClient)
...
lazy val root = (project in file("."))
  ...
  .dependsOn(cromwellClientInterface)
  ...
  .aggregate(cromwellClientInterface)
  .aggregate(cwl)

...
//      }
  ...
  private[jes] def generateJesOutputs(jobDescriptor: BackendJobDescriptor): Set[JesFileOutput] = {
    // TODO WOM: How to get output files generated by a task ?
    val wdlFileOutputs = List.empty[WdlValue]//call.task.findOutputFiles(jobDescriptor.fullyQualifiedInputs, PureStandardLibraryFunctions) map relativeLocalizationPath

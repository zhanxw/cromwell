...
//    }
  ...
  object DeclarationKey {
    def apply(declaration: ExpressionNode, index: ExecutionIndex): DeclarationKey = {
  ...
  case class DynamicDeclarationKey(node: ExpressionNode, index: ExecutionIndex) extends DeclarationKey {
    import lenthall.validation.ErrorOr._
